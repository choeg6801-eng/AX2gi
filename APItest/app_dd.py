...
# 4. 지원 국가 데이터 (요청하신 정확한 핫플레이스 항목명과 올바른 매칭 이미지 적용)
LOCATION_DATA = {
    "프랑스 (파리)": {
        "city": "Paris", "currency": "EUR", "symbol": "€", 
        "base_rate": 1450, "price_level": "약 130% (외식비와 숙박비가 높은 편)", 
        "trade_export": "항공기, 화장품, 의류, 와인",
        "trade_import": "의약품, 기계류, 석유제품, 자동차",
        "trade_culture": "프랑스어 사용을 선호하며 격식과 예절, 인맥을 중요하게 여김",
        "trade_economy": "유럽연합 내 핵심 경제국으로 명품 및 항공우주 산업 중심",
        "packing_tip": "유럽형 멀티어댑터, 우산, 편한 워킹화",
        "safety_info": "주요 관광지 및 지하철 내 소매치기, 사기꾼 주의",
        "must_visit": "에펠탑, 개선문, 루브르 박물관",
        "images": [
            "https://images.unsplash.com/photo-1511739001486-6bfe10ce785f?auto=format&fit=crop&w=600&q=80",
            "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=600&q=80",
            "https://images.unsplash.com/photo-1549877452-9c387954fbc2?auto=format&fit=crop&w=600&q=80"
        ]
    },
    "미국 (뉴욕)": {
        ...
        "safety_info": "전반적으로 안전하나 심야 시간대의 지하철역이나 우범 지역은 단독 통행 피하기",
        "must_visit": "센트럴파크, 브로드웨이, 타임스퀘어",
        "images": [
    ...
    "중국 (베이징)": {
        "city": "Beijing", "currency": "CNY", "symbol": "¥", 
        "base_rate": 190, "price_level": "약 75% (물가와 대중교통비가 비교적 저렴함)", 
        "trade_export": "반도체, 평판디스플레이, 석유화학, 컴퓨터",
        "trade_import": "메모리 반도체, 정밀화학, 원유, 농산물",
        "trade_culture": "관계(꽌시)와 체면을 중시하며 비즈니스 만찬과 술자리가 매우 중요함",
        "trade_economy": "부동산 시장 조정 및 대내외 통상 마찰 속에서 질적 성장을 추진 중",
        "packing_tip": "중국용 어댑터, 마스크(대기질 대비), 위챗페이/알리페이 세팅",
        "safety_info": "치안은 양호하나 인파가 몰리는 관광지에서 소매치기 주의",
        "must_visit": "자금성, 만리장성, 천안문",
        "images": [
            "https://images.unsplash.com/photo-1508804052814-cd38265c637a?auto=format&fit=crop&w=600&q=80",
            "https://images.unsplash.com/photo-1508804052814-cd38265c637a?auto=format&fit=crop&w=600&q=80",
            "https://images.unsplash.com/photo-1599571234909-2915287f0f49?auto=format&fit=crop&w=600&q=80"
        ]
    },
    "베트남 (하노이)": {
        "city": "Hanoi", "currency": "VND", "symbol": "₫", 
        "base_rate": 0.055, "price_level": "약 50% (체감 물가가 매우 저렴함)", 
        "trade_export": "무선통신기기, 컴퓨터, 철강, 섬유의류",
        "trade_import": "집적회로, 전자부품, 기계류, 직물",
        "trade_culture": "연장자에 대한 예우와 상호 존중을 중시하며 부드럽고 유연한 태도 선호",
        "trade_economy": "외국인 투자(FDI) 유치 확대와 제조업 중심의 가파른 경제 성장세",
        "packing_tip": "우산(스콜 대비), 모기 기피제, 가벼운 옷차림",
        "safety_info": "오토바이 날치기 및 소매치기 주의, 횡단보도 건널 때 각별한 유의",
        "must_visit": "하롱베이, 호안끼엠 호수, 응옥썬 사",
        "images": [
    ...
    "러시아 (모스크바)": {
        "city": "Moscow", "currency": "RUB", "symbol": "₽", 
        "base_rate": 15, "price_level": "약 60% (대외 제재 여파로 물가 변동성 큼)", 
        "trade_export": "기계류, 자동차, 화학제품",
        "trade_import": "원유, 천연가스, 금속, 밀",
        "trade_culture": "초반에는 다소 엄격하고 냉랭해 보일 수 있으나 신뢰가 쌓이면 매우 호의적임",
        "trade_economy": "대내외 경제 제재 속 자급자족 중심의 산업 구조 개편 진행 중",
        "packing_tip": "방한용품(겨울철 매우 추움), 러시아어 번역 앱",
        "safety_info": "정치적 집회 장소 접근 자제 및 야간 단독 통행 주의",
        "must_visit": "붉은 광장, 크렘린 궁전, 성 바실리 대성당",
        "images": [
            "https://images.unsplash.com/photo-1513326738677-b964603b146d?auto=format&fit=crop&w=600&q=80",
            "https://images.unsplash.com/photo-1520106218999-8c0079b5c3d2?auto=format&fit=crop&w=600&q=80",
            "https://images.unsplash.com/photo-1547448415-e9f5b28e570d?auto=format&fit=crop&w=600&q=80"
        ]
    },
    "튀르키예 (이스탄불)": {
        "city": "Istanbul", "currency": "TRY", "symbol": "₺", 
        "base_rate": 40, "price_level": "약 65% (고인플레이션으로 물가 변동 심함)", 
        "trade_export": "자동차, 기계류, 철강, 직물",
        "trade_import": "광물성 연료, 귀금속, 기계, 플라스틱",
        "trade_culture": "인간관계를 중시하며 차(Tea) 대접 문화를 통한 친밀감 형성 선호",
        "trade_economy": "높은 인플레이션과 통화 가치 하락 속에서도 탄탄한 제조업 기반 유지",
        "packing_tip": "사원 방문용 스카프/긴바지, 멀티어댑터",
        "safety_info": "관광지 호객꾼 및 소매치기 주의",
        "must_visit": "블루 모스크, 하기아 소피아, 그랜드 바자르",
        "images": [
            ...
            "https://images.unsplash.com/photo-1527838832700-505925227f7a?auto=format&fit=crop&w=600&q=80"
        ]
    },
    "브라질 (상파울루)": {
    ...
    "멕시코 (멕시코시티)": {
        ...
        "trade_culture": "개인적인 신뢰와 유대감을 중시하며, 악수와 인사를 나누는 정중한 태도 필요",
        "trade_economy": "미국 인접 효과로 제조업 및 의료기기·제약 분야 투자가 급증하는 유망 시장",
        "packing_tip": "고고도 대비 자외선 차단제, 가벼운 외투, 멀티어댑터",
        "safety_info": "공식 택시 이용 필수 및 야간 인적이 드문 장소 이동 자제",
        "must_visit": "차풀테페크 공장, 프리다 칼로 미술관, 소칼로 광장",
        "images": [
    ...
    "일본 (도쿄)": {
        ...
        "trade_import": "LNG, 원유, 의류, 식료품",
        "trade_culture": "격식 있는 호칭과 철저한 비즈니스 예절, 신뢰 구축 중시",
        "trade_economy": "완만한 임금 상승과 관광객 유입으로 내수 회복세이나 엔화 변동성 주의",
        "packing_tip": "동전 지갑, 돼지코(110V), 숙소용 슬리퍼",
        "safety_info": "세계에서 가장 치안이 안전한 국가 중 하나",
    ...
    "영국 (런던)": {
        ...
        "safety_info": "번화가나 지하철 내에서 오토바이 날치기나 소매치기 주의",
        "must_visit": "타워 브릿지, 런던아이, 대영 박물관",
        "images": [
    ...
    "네덜란드 (암스테르담)": {
        ...
        "trade_culture": "매우 직설적이고 실용적인 화법을 구사하며 빠른 결론과 효율성 추구",
        "trade_economy": "유럽의 물류·유통 허브이며 ASML 등 첨단 반도체 및 의료 기술 인프라 발달",
        "packing_tip": "방수 자켓, 자전거 전용 도로 주의용 운동화",
        "safety_info": "자전거 전용 도로가 많아 보행 시 교통사고 유의 및 소매치기 주의",
        "must_visit": "반 고흐 미술관, 암스테르담 국립 미술관, 운하 크루즈",
        "images": [
    ...
    "스위스 (취리히)": {
        ...
        "trade_culture": "시간 엄수가 절대적이며 정확성, 신뢰성, 문서 기록 중시",
        "trade_economy": "제약 및 바이오, 정밀 의료기기 산업의 세계적 중심지",
        "packing_tip": "J타입 어댑터, 넉넉한 예산 준비",
        "safety_info": "치안 상태가 매우 우수하며 범죄율이 낮음",
    ...
    "독일 (베를린)": {
        ...
        "trade_culture": "엄격한 규정과 절차 준수, 공사 구분 명확, 서면 검토 요구",
        "trade_economy": "제조업 부진 및 에너지 전환 비용 증가로 완만한 성장 정체 국면",
        "packing_tip": "EU 어댑터, 방수 바람막이, 동전 지갑",
        "safety_info": "기차역 주변이나 야간 번화가에서 소지품 주의",
    ...
    "이탈리아 (로마)": {
        ...
        "trade_import": "에너지, 의약품, 철강, 전자부품",
        "trade_culture": "인간관계를 중요하게 생각하며 미팅 전 스몰토크로 친밀감 형성",
        "trade_economy": "공공 보건 의료 부문의 의료기기 현대화 사업 지속 진행 중",
        "packing_tip": "소매치기 방지 백팩, 유적지 관람용 편한 운동화",
        "safety_info": "관광객 대상 소매치기, 날치기 및 사기꾼 주의",
    ...
    "오스트리아 (비엔나)": {
        ...
        "trade_culture": "공식 직함과 학위를 중요하게 여기며 격식 있는 태도 요구",
        "trade_economy": "중동부 유럽 비즈니스 거점 및 안정적인 제약·의료 산업 인프라 보유",
        "packing_tip": "EU 규격 어댑터, 클래식 공연용 단정한 옷차림",
        "safety_info": "주요 관광지 주변 소매치기만 주의하면 매우 안전함",
    ...
    "콜롬비아 (보고타)": {
        ...
        "trade_culture": "격식 있는 호칭과 정중한 태도를 중시하며 우회적인 표현 사용",
        "trade_economy": "중남미 보건의료 허브로 제약 및 첨단 의료기기 수입 수요 활발",
        "packing_tip": "고산지대 대비 우산, 따뜻한 겉옷",
        "safety_info": "소매치기 및 날치기 범죄 빈번하므로 고가품 노출 자제",
    ...
    "칠레 (산티아고)": {
        ...
        "base_rate": 1.4, "price_level": "약 80% (남미에서 경제적 안정성과 투명성 높음)", 
        "trade_export": "자동차, 기계류, 석유제품, 철강",
        "trade_import": "의료기기, 의약품, 광산용 장비, IT 기기",
        "trade_culture": "시간 약속을 철저히 지키며 비즈니스 매너가 투명함",
        "trade_economy": "병원 인프라 현대화로 첨단 의료기기 및 제약 분야 수입 의존도 높음",
        "packing_tip": "자외선 차단제, 선글라스, 보습 용품",
        "safety_info": "관광지 및 지하철 내 소매치기, 차량털이 범죄 주의",
        "must_visit": "산타 루시아 언덕, 아라스 광장, 스카이 코스타네",
        "images": [
            "https://images.unsplash.com/photo-1512813266185-3b1f5fc23015?auto=format&fit=crop&w=600&q=80",
            "https://images.unsplash.com/photo-1483729558449-99ef09a8c325?auto=format&fit=crop&w=600&q=80",
            "https://images.unsplash.com/photo-1534430480872-3498386e7856?auto=format&fit=crop&w=600&q=80"
    ...
    "아르헨티나 (부에노스아이레스)": {
        ...
        "base_rate": 1.5, "price_level": "약 60% (환율 체감상 물가가 저렴함)", 
        "trade_export": "기계류, 자동차 부품, 화학제품, 플라스틱",
        "trade_import": "곡물, 육류, 리튬, 원유 및 가스",
        "trade_culture": "친근한 스킨십과 대화를 선호하며 유대감 형성 후 거래 진행",
        "trade_economy": "만성적 고인플레이션과 복잡한 외환 규제로 대금 결제 리스크 관리 필수",
        "packing_tip": "어댑터, 넉넉한 현금(달러 선호), 편한 산책화",
        "safety_info": "오토바이 소매치기 및 날치기 빈번하므로 통화 시 주의",
        "must_visit": "라보카, 5월 광장, 오벨리스크",
        "images": [
            "https://images.unsplash.com/photo-1589909202874-17f975762af0?auto=format&fit=crop&w=600&q=80",
    ...
    "호주 (시드니)": {
        ...
        "safety_info": "치안이 안정적이나 해변가나 유흥가 심야 시간대 주의",
