...
try:
 ...
 st.dataframe(over_35[["Name","Sex","Age"]].head()) #head의 기본값은 5 
...
#성별 여자 남자 필터링 2컬럼 사용 
 ...
 with col2: 
    st.metric(f"남성 승객수:",f"**{len(male_df)}명**")
st.markdown("---")
...
st.metric("35세 이상 & 여성 승객 수",f"{len(over_35_female)}명")
